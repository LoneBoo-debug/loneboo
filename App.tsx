    ...
    <div className="min-h-screen font-sans flex flex-col relative w-full h-full">
        ...
        <main className="flex-1 relative w-full h-full">
            ...
            <Suspense fallback={<PageLoader />}>
                ...
                {currentView === AppView.MEDIE_ITALIANO && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/newitaliansfondopage.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.ITALIANO} />}
                {currentView === AppView.MEDIE_INGLESE && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/inglesesfondprgrge445.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.INGLESE} />}
                {currentView === AppView.MEDIE_STORIA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/storiasfondpagtr4e3w.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.STORIA} />}
                {currentView === AppView.MEDIE_GEOGRAFIA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/geonewsfondopagrte4ew.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.GEOGRAFIA} />}
                {currentView === AppView.MEDIE_ARTE && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/artenesdwrfpage4w.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.ARTE} />}
                {currentView === AppView.MEDIE_TECNOLOGIA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/tecnopagefred44.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.TECNOLOGIA} />}
                {currentView === AppView.MEDIE_MATEMATICA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/matealbertopaged.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.MATEMATICA} />}
                {currentView === AppView.MEDIE_SCIENZE && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/scienzesfondpagtre321.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.SCIENZE} />}
                {currentView === AppView.MEDIE_ESPERIMENTI && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/epseimentisfondpag5554re.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.ESPERIMENTI} />}
                {currentView === AppView.MEDIE_INFORMATICA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/informspfondpage556tr.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.INFORMATICA} />}
                {currentView === AppView.MEDIE_CIVICA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/civichdesfondejrjwa.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.CIVICA} />}
                {currentView === AppView.MEDIE_MOTORIA && <MedieSubjectPage bgUrl="https://loneboo-images.s3.eu-south-1.amazonaws.com/motoriasfondopagtre44.webp" setView={handleSetView} backView={lastClassroomView} grade={lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_1 ? 6 : lastClassroomView === AppView.RAINBOW_CITY_SCUOLA_MEDIA_2 ? 7 : 8} subject={SchoolSubject.MOTORIA} />}
