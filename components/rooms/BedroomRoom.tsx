...
const BAULE_BG_MOBILE = 'https://i.postimg.cc/kXB7MZWz/bauden.jpg';
const BAULE_BG_DESKTOP = 'https://i.postimg.cc/h4mHCBbq/bayyert.jpg';
...
const BaulePage: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    ...
    if (activeSubGame === 'fionda') {
        ...
        return <SlingShotGame onBack={() => setActiveSubGame(null)} />;
    }
...
const BedroomRoom: React.FC<{ setView: (v: AppView) => void }> = ({ setView }) => {
    ...
    const ZONES_MOBILE = [
      { "id": "libri", "label": "Bosco delle Fiabe", "points": [ { "x": 73.56, "y": 72.55 }, { "x": 85.29, "y": 72.21 }, { "x": 80.76, "y": 81.57 }, { "x": 73.03, "y": 78.85 } ] },
    ...
    const ZONES_DESKTOP = [
      { "id": "libri", "label": "Bosco delle Fiabe", "points": [ { "x": 59.74, "y": 78.31 }, { "x": 59.54, "y": 87.53 }, { "x": 61.85, "y": 90.46 }, { "x": 65.66, "y": 80.33 } ] },
