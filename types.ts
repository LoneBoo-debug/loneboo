...
export enum AppView {
  ...
  LAKE_CITY = 'LAKE_CITY',
  LAKE_CITY_ACQUARIO = 'LAKE_CITY_ACQUARIO',
  LAKE_CITY_MUSEO = 'LAKE_CITY_MUSEO',
  LAKE_CITY_LAGO = 'LAKE_CITY_LAGO',
  LAKE_CITY_MOLO = 'LAKE_CITY_MOLO',
  ...
  VISTA_TORRE = 'VISTA_TORRE',
  CINEMA_PREVIEW = 'CINEMA_PREVIEW',
  ...
  MOUNTAIN_CITY_OSSERVATORIO = 'MOUNTAIN_CITY_OSSERVATORIO',
  MOUNTAIN_CITY_CENTRO_METEO = 'MOUNTAIN_CITY_CENTRO_METEO',
